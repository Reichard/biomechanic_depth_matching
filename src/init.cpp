...
extern "C" {
    ...
    SOFA_CmakePlugin_API const char* getModuleVersion();
    SOFA_CmakePlugin_API const char* getModuleLicense();
    SOFA_CmakePlugin_API const char* getModuleDescription();
    SOFA_CmakePlugin_API const char* getModuleComponentList();
}
...
const char* getModuleComponentList()
{
    ...
    return "TestComponent, DepthInputComponent, MumpsSolver, \
    	   MyCudaSpringForceField, MyCudaMechanicalObject";
