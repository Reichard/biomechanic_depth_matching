...
BiomechanicalDepthMatching::BiomechanicalDepthMatching() 
...
void BiomechanicalDepthMatching::draw(const sofa::core::visual::VisualParams *params)
{
	//draw_association();
	//draw_error();
	draw_data_positions();
...
void BiomechanicalDepthMatching::draw_association()
{
	_fbo.bind_read();
...
void BiomechanicalDepthMatching::draw_error()
{
...
void BiomechanicalDepthMatching::draw_data_positions()
{
	glpp::disable_lighting();
...
void BiomechanicalDepthMatching::draw_ground_truth()
{
	glpp::disable_lighting();
...
void BiomechanicalDepthMatching::draw_ground_truth_volume()
{
	glpp::disable_lighting();
...
void BiomechanicalDepthMatching::read_next_frame()
{
...
void BiomechanicalDepthMatching::update() 
{
...
void BiomechanicalDepthMatching::handleEvent(sofa::core::objectmodel::Event *event)
{
	if(dynamic_cast<sofa::simulation::AnimateBeginEvent*>(event))
		update();
}

void BiomechanicalDepthMatching::setup_scene() 
{
...
void BiomechanicalDepthMatching::init()
{
	setup_scene();
...
std::future<bool> BiomechanicalDepthMatching::read_rgbd_data_async(int frame)
{
...
void BiomechanicalDepthMatching::write_surface_ascii(const std::string &path)
{
	auto &triangles = _ogl_model->getTriangles();
...
void BiomechanicalDepthMatching::write_surface_stl(const std::string &path)
{
...
int BiomechanicalDepthMatchingClass = sofa::core::RegisterObject("").add<BiomechanicalDepthMatching>();
