...
#include "../../../../../../ext/sofa/extlibs/libQGLViewer-2.6.3/QGLViewer/camera.h"
...
struct qt_meta_stringdata_qglviewer__Camera_t {
    ...
    char stringdata[1012];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_qglviewer__Camera_t, stringdata) + ofs \
