...
#include "../../../../../../ext/sofa/applications/sofa/gui/qt/QTransformationWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__QTransformationWidget_t, stringdata) + ofs \
...
void sofa::gui::qt::QTransformationWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QTransformationWidget::TransformationDirty)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject sofa::gui::qt::QTransformationWidget::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__QTransformationWidget.data,
      qt_meta_data_sofa__gui__qt__QTransformationWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *sofa::gui::qt::QTransformationWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__QTransformationWidget.stringdata))
        return static_cast<void*>(const_cast< QTransformationWidget*>(this));
