...
#include "../../../../../../ext/sofa/applications/sofa/gui/qt/SofaMouseManager.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__SofaMouseManager_t, stringdata) + ofs \
...
const QMetaObject sofa::gui::qt::SofaMouseManager::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__SofaMouseManager.data,
      qt_meta_data_sofa__gui__qt__SofaMouseManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *sofa::gui::qt::SofaMouseManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__SofaMouseManager.stringdata))
        return static_cast<void*>(const_cast< SofaMouseManager*>(this));
