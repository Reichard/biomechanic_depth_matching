...
#include "../../../../../../ext/sofa/applications/sofa/gui/qt/SimpleDataWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__RadioDataWidget_t, stringdata) + ofs \
...
const QMetaObject sofa::gui::qt::RadioDataWidget::staticMetaObject = {
    { &TDataWidget<sofa::helper::OptionsGroup>::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__RadioDataWidget.data,
      qt_meta_data_sofa__gui__qt__RadioDataWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *sofa::gui::qt::RadioDataWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__RadioDataWidget.stringdata))
        return static_cast<void*>(const_cast< RadioDataWidget*>(this));
