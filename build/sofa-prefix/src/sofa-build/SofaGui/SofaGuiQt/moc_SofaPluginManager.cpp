...
#include "../../../../../../ext/sofa/applications/sofa/gui/qt/SofaPluginManager.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sofa__gui__qt__SofaPluginManager_t, stringdata) + ofs \
...
void sofa::gui::qt::SofaPluginManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SofaPluginManager::libraryAdded)) {
                *result = 0;
            }
        }
        {
            typedef void (SofaPluginManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SofaPluginManager::libraryRemoved)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject sofa::gui::qt::SofaPluginManager::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_sofa__gui__qt__SofaPluginManager.data,
      qt_meta_data_sofa__gui__qt__SofaPluginManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *sofa::gui::qt::SofaPluginManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sofa__gui__qt__SofaPluginManager.stringdata))
        return static_cast<void*>(const_cast< SofaPluginManager*>(this));
    if (!strcmp(_clname, "Ui_PluginManager"))
        return static_cast< Ui_PluginManager*>(const_cast< SofaPluginManager*>(this));
