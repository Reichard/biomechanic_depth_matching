...
******************************************************************************/
#ifndef SOFA_COMPONENT_LOADER_MeshExtendedVTKLoader_H
#define SOFA_COMPONENT_LOADER_MeshExtendedVTKLoader_H
...
class SOFA_LOADER_API MeshExtendedVTKLoader : public sofa::core::loader::MeshLoader
{
public:
	typedef topology::QuadraticMeshTopology::QuadTetra QuadraticTetrahedron;

	Data< helper::vector< QuadraticTetrahedron > > quadraticTetrahedra;

	Data< helper::vector< sofa::core::loader::PrimitiveGroup > > quadraticTetrahedraGroups;

protected:

	void addQuadraticTetrahedron(helper::vector<QuadraticTetrahedron>* pQuadraticTetrahedra, const QuadraticTetrahedron &p);
	void addQuadraticTetrahedron(helper::vector<QuadraticTetrahedron>* pQuadraticTetrahedra, unsigned int p0, unsigned int p1, unsigned int p2, unsigned int p3, unsigned int p4, unsigned int p5, unsigned int p6, unsigned int p7, unsigned int p8, unsigned int p9);
...
public:
	SOFA_CLASS(MeshExtendedVTKLoader,sofa::core::loader::MeshLoader);
