...
******************************************************************************/
/*
 * ExtendedVTKExporter.h
 *
 *  Created on: 9 sept. 2009
 *      Author: froy
 */

#ifndef ExtendedVTKExporter_H_
#define ExtendedVTKExporter_H_
...
class SOFA_EXPORTER_API ExtendedVTKExporter : public core::objectmodel::BaseObject
{
public:
        SOFA_CLASS(ExtendedVTKExporter,core::objectmodel::BaseObject);
...
public:
	 ...
	 Data<bool> writeQuadraticTetras;
