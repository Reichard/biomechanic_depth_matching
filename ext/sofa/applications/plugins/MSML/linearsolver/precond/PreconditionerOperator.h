...
******************************************************************************/
#ifndef SOFA_COMPONENT_LINEARSOLVER_PreconditionerOperator_H
#define SOFA_COMPONENT_LINEARSOLVER_PreconditionerOperator_H
...
class PreconditionerOperator : public sofa::component::linearsolver::MatrixLinearSolver< sofa::component::linearsolver::GraphScatteredMatrix, sofa::component::linearsolver::GraphScatteredVector >
{
public:
	SOFA_CLASS(SOFA_TEMPLATE(PreconditionerOperator,TReal),SOFA_TEMPLATE2(sofa::component::linearsolver::MatrixLinearSolver, sofa::component::linearsolver::GraphScatteredMatrix,  sofa::component::linearsolver::GraphScatteredVector) );
  ...
  //  typedef typename Matrix::Real Real;
   ...
   MatrixInvertData * createInvertData() {
      return new PreconditionerOperatorInvertData();
    }

   static std::string Name() { return "CPU"; }

protected:
    class PreconditionerOperatorInvertData : public MatrixInvertData {
      public :
    	PrecondVectorType B;
    	PrecondVectorType R;
...
//		  Real *y;
	    ...
	    PreconditionerOperatorInvertData() {
//	      uplo='0';
//		  diag ='0';
//		  m =0;
//		  a = NULL;
