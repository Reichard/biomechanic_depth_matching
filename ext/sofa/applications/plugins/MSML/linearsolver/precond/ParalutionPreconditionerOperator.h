...
******************************************************************************/
#ifndef SOFA_COMPONENT_LINEARSOLVER_ParalutionPreconditionerOperator_H
#define SOFA_COMPONENT_LINEARSOLVER_ParalutionPreconditionerOperator_H
...
#include <sofa/gpu/cuda/CudaMatrix.h>
...
class ParalutionPreconditionerOperator : public sofa::component::linearsolver::MatrixLinearSolver< sofa::component::linearsolver::GraphScatteredMatrix, sofa::component::linearsolver::GraphScatteredVector >
{
public:
	SOFA_CLASS(SOFA_TEMPLATE(ParalutionPreconditionerOperator,TReal),SOFA_TEMPLATE2(sofa::component::linearsolver::MatrixLinearSolver, sofa::component::linearsolver::GraphScatteredMatrix,  sofa::component::linearsolver::GraphScatteredVector) );
  ...
  //  typedef typename Matrix::Real Real;
   ...
   MatrixInvertData * createInvertData() {
      return new ParalutionPreconditionerOperatorInvertData();
    }

   static std::string Name() { return "Paralution"; }

protected:
    class ParalutionPreconditionerOperatorInvertData : public MatrixInvertData {
      public :
    	PrecondVectorType B;
    	PrecondVectorType R;
    	...
    	GPUVectorType B_GPU;
    	GPUVectorType R_GPU;
    	GPUVectorType X1_GPU;


	    ParalutionPreconditionerOperatorInvertData() {
