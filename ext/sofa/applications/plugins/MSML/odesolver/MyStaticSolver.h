...
#ifndef SOFA_COMPONENT_ODESOLVER_MyStaticSolver_H
#define SOFA_COMPONENT_ODESOLVER_MyStaticSolver_H
...
class MyStaticSolver : public sofa::core::behavior::OdeSolver
{

public:
    SOFA_CLASS(MyStaticSolver, sofa::core::behavior::OdeSolver);
    MyStaticSolver();
