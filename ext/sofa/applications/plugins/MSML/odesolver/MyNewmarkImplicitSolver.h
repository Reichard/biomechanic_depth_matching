...
******************************************************************************/
#ifndef SOFA_COMPONENT_ODESOLVER_MyNewmarkImplicitSolver_H
#define SOFA_COMPONENT_ODESOLVER_MyNewmarkImplicitSolver_H
 ...
 *
*/
class MyNewmarkImplicitSolver : public sofa::core::behavior::OdeSolver
{
protected:
    int cpt;
...
public:
    SOFA_CLASS(MyNewmarkImplicitSolver, sofa::core::behavior::OdeSolver);
