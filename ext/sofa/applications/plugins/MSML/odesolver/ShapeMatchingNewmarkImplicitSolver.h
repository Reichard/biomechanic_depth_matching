...
******************************************************************************/
#ifndef SOFA_COMPONENT_ODESOLVER_ShapeMatchingNewmarkImplicitSolver_H
#define SOFA_COMPONENT_ODESOLVER_ShapeMatchingNewmarkImplicitSolver_H
 ...
 *
*/
class ShapeMatchingNewmarkImplicitSolver : public sofa::core::behavior::OdeSolver
{
protected:
    int cpt;
    bool printVectorAsMatlabFiles(const core::ExecParams* params, core::MultiVecDerivId  vec,const char* filename, int stepNumber);
    bool printCurrentPositionAsMatlabFile(const core::ExecParams* params, const char* filename, int stepNumber);

public:
    SOFA_CLASS(ShapeMatchingNewmarkImplicitSolver, sofa::core::behavior::OdeSolver);
    ...
    Data<double> f_delta;
    Data<double> f_alpha;
    Data<int> m_LinearIterations;

    ShapeMatchingNewmarkImplicitSolver();
...
//	void setPrintMatricesFlag()
//	{
//		this->printMatricesFlag = 1;
//	}

//private:
//
//	bool printVector(sofa::core::MultiVecDerivId rhs, char* name);
//	bool printMatrix(sofa::core::MultiVecDerivId rhs, char* name);
//	bool printMatricesFlag;
