...
******************************************************************************/
#define SOFA_COMPONENT_FORCEFIELD_LANDMARKSPRINGFORCEFIELD_CPP

#include <LandmarkSpringsForceField.inl>
...
SOFA_DECL_CLASS(LandmarkSpringsForceField)
...
template<>
void LandmarkSpringsForceField<Rigid3dTypes>::addForce(const core::MechanicalParams* /* mparams */ /* PARAMS FIRST */, DataVecDeriv& f, const DataVecCoord& x, const DataVecDeriv& /* v */)
{
...
template<>
void LandmarkSpringsForceField<Rigid3dTypes>::addDForce(const core::MechanicalParams* mparams /* PARAMS FIRST */, DataVecDeriv& df, const DataVecDeriv& dx)
{
...
template<>
void LandmarkSpringsForceField<Rigid3dTypes>::addKToMatrix(const core::MechanicalParams* mparams /* PARAMS FIRST */, const sofa::core::behavior::MultiMatrixAccessor* matrix )
{
    const VecReal& k = stiffness.getValue();
    const VecReal& k_a = angularStiffness.getValue();
    const int N = 6;
...
template<>
void LandmarkSpringsForceField<Rigid3dTypes>::draw(const core::visual::VisualParams* vparams)
{
...
template<>
void LandmarkSpringsForceField<Rigid3fTypes>::addForce(const core::MechanicalParams* /* mparams */ /* PARAMS FIRST */, DataVecDeriv& f, const DataVecCoord& x, const DataVecDeriv& /* v */)
{
    sofa::helper::WriteAccessor< DataVecDeriv > f1 = f;
    sofa::helper::ReadAccessor< DataVecCoord > p1 = x;
...
template<>
void LandmarkSpringsForceField<Rigid3fTypes>::addDForce(const core::MechanicalParams* mparams /* PARAMS FIRST */, DataVecDeriv& df, const DataVecDeriv& dx)
{
    sofa::helper::WriteAccessor< DataVecDeriv > df1 = df;
    sofa::helper::ReadAccessor< DataVecDeriv > dx1 = dx;
    double kFactor = mparams->kFactor();
...
template<>
void LandmarkSpringsForceField<Rigid3fTypes>::addKToMatrix(const core::MechanicalParams* mparams /* PARAMS FIRST */, const sofa::core::behavior::MultiMatrixAccessor* matrix )
{
    const VecReal& k = stiffness.getValue();
    const VecReal& k_a = angularStiffness.getValue();
    const int N = 6;
...
template<>
void LandmarkSpringsForceField<Rigid3fTypes>::draw(const core::visual::VisualParams* vparams)
{
#ifndef SOFA_NO_OPENGL
    if (!vparams->displayFlags().getShowForceFields())
        return;  /// \todo put this in the parent class
...
/*
template<>
void LandmarkSpringsForceField<Vec3dTypes>::addDForce(VecDeriv& df, const VecDeriv &dx, double kFactor, double )
{
const VecIndex& indices = points.getValue();
const VecReal& k = stiffness.getValue();
...
template<>
void LandmarkSpringsForceField<Vec3dTypes>::draw(const core::visual::VisualParams* vparams)
{
#ifndef SOFA_NO_OPENGL
    if (!vparams->displayFlags().getShowForceFields())
        return;  /// \todo put this in the parent class
...
int LandmarkSpringsForceFieldClass = core::RegisterObject("Simple elastic springs applied to given degrees of freedom between their current and rest shape position")
#ifndef SOFA_FLOAT
        .add< LandmarkSpringsForceField<Vec3dTypes> >()
//.add< LandmarkSpringsForceField<Vec2dTypes> >()
        .add< LandmarkSpringsForceField<Vec1dTypes> >()
//.add< LandmarkSpringsForceField<Vec6dTypes> >()
        .add< LandmarkSpringsForceField<Rigid3dTypes> >()
//.add< LandmarkSpringsForceField<Rigid2dTypes> >()
#endif
#ifndef SOFA_DOUBLE
        .add< LandmarkSpringsForceField<Vec3fTypes> >()
//.add< LandmarkSpringsForceField<Vec2fTypes> >()
        .add< LandmarkSpringsForceField<Vec1fTypes> >()
//.add< LandmarkSpringsForceField<Vec6fTypes> >()
        .add< LandmarkSpringsForceField<Rigid3fTypes> >()
//.add< LandmarkSpringsForceField<Rigid2fTypes> >()
#endif
        ;

#ifndef SOFA_FLOAT
template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Vec3dTypes>;
//template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Vec2dTypes>;
template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Vec1dTypes>;
//template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Vec6dTypes>;
template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Rigid3dTypes>;
//template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Rigid2dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Vec3fTypes>;
//template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Vec2fTypes>;
template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Vec1fTypes>;
//template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Vec6fTypes>;
template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Rigid3fTypes>;
//template class SOFA_DEFORMABLE_API LandmarkSpringsForceField<Rigid2fTypes>;
#endif
